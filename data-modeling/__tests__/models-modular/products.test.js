...
describe('Products Model (Modular)', () => {
  ...
  it('can create() a new product', async () => {
    ...
    let record = await products.create(productObj);
  ...
  it('can get() all products', async () => {
    await products.create({ name: 'Test1', price: 5.49, quantity: 7, inStock: true });
    await products.create({ name: 'Test2', price: 11.99, quantity: 1, inStock: true });
    await products.create({ name: 'Test3', price: 8.33, quantity: 0, inStock: false });
  ...
  it('can update() a product', async () => {
    let record = await products.create({ name: 'Test4', price: 5.49, quantity: 7, inStock: true });
    let updated = await products.update(record._id, { name: 'Updated - Test4', price: 5.49, quantity: 6, inStock: true });
  ...
  it('can delete() a product', async () => {
    let record = await products.create({ name: 'Test5', price: 5.49, quantity: 7, inStock: true });
